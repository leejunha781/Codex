...
$pdfPath = 'D:\이력서\AVEVA - Business Development Manager\Joonha_Lee_AVEVA_BDM_Engineering_Marine_Korea_Japan_Seoul_Resume_ATS_2Page.pdf'
...
for ($idx = 0; $idx -lt $pdfDoc.PageCount; $idx++) {
    ...
    $png = Join-Path $outDir ("ats_page{0}.png" -f ($idx + 1))
