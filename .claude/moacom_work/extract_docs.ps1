...
$files = @(
    @{ Path = "D:\이력서\모아컴코리아 - HW 개발\이준하_모아컴코리아_HW설계_최종.docx"; Out = "C:\Users\namma\.claude\moacom_work\dump_choejong.txt" },
    @{ Path = "D:\이력서\모아컴코리아 - HW 개발\이준하_모아컴 코리아_HW 개발.docx"; Out = "C:\Users\namma\.claude\moacom_work\dump_yangsik.txt" }
)
