...
$md   = $dir + "Future_Industrial_PLM_Presenter_Facilitation_Guide_EN.md"
$docx = $dir + "Future_Industrial_PLM_Presenter_Facilitation_Guide_EN.docx"
$pdf  = $dir + "Future_Industrial_PLM_Presenter_Facilitation_Guide_EN.pdf"
...
try {
    ...
    $ftr.Text = "Presenter's Facilitation Guide  |  Future Industrial PLM - AVEVA Marine  |  page "
