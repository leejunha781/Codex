...
$pdf = "D:\이력서\AVEVA - Marine Principal Technical Support & Consultant – PLM SME, Busan\Proposal\Future_Industrial_PLM_Presenter_Facilitation_Guide_KO.pdf"
$outdir = "C:\Users\namma\.claude\plm_slide_work\guide_ko_qa_render"
...
foreach($idx in @(0,3,7,9)){
    ...
    $out = Join-Path $outdir ("guide_ko_p{0:00}.png" -f ($idx+1))
