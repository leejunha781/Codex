...
## 2026-08-18 13:35 UTC
- Topic: control-valve-hart-commissioning-evidence
- Angle: HART/stroke-test data becomes commissioning evidence only through gated, accountable acceptance dispositions
- Marine execution context: control-valve commissioning evidence (loop-list reconciliation, signature acceptance bands, disposition log into handover dossier)
- Post path: C:\Users\namma\Documents\Codex\2026-08-18\control-valve-hart-commissioning-evidence\linkedin-post.md
- Image path: C:\Users\namma\Documents\Codex\2026-08-18\control-valve-hart-commissioning-evidence\control-valve-hart-commissioning-evidence-infographic.png
- Image QA: text-fit pass | leader-lines pass | overlap QA pass | satcom-reference style pass | 1536x1024 pass | C2PA absent pass (photo-diversity N/A, flat vector)
- Image source: built-in image generation tool (per Image generation rule)
